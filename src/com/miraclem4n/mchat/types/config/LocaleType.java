...
public enum LocaleType
{
  ...
  public String getVal() {
    if (LocaleUtil.getConfig().isSet(this.option)) {
      return MessageUtil.addColour(LocaleUtil.getConfig().getString(this.option));
    }
    return "Locale Option '" + this.option + "' not found!";
  }

  public String getRaw() {
    if (LocaleUtil.getConfig().isSet(this.option)) {
      return LocaleUtil.getConfig().getString(this.option);
    }
    return "Locale Option '" + this.option + "' not found!";
  }
}